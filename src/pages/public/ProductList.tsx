    ...
    <div className="container mx-auto px-4 py-8 pt-[100px]">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <aside className="lg:w-64 flex-shrink-0">
          <div className="card sticky top-24 rounded-xl">
            ...
            <div>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className={`block w-full text-left px-3 py-2 rounded-lg transition-colors ${!selectedCategory ? "bg-primary-50 text-primary-700 font-medium" : "hover:bg-gray-100"
                    }`}
                >
                  All Categories
                </button>
