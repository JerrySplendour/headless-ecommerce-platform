...
export default function CollectionCreate() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: any) => productsAPI.createCollection(data),
    onSuccess: () => {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Group products into a collection</p>
          </div>
        </div>
        <div className="flex gap-3">
          <button onClick={() => navigate("/dashboard/products")} className="btn btn-secondary">
            Cancel
          </button>
            ...
            <div className="card">
              ...
              {image ? (
                ...
                <button
                  type="button"
                  onClick={() => setShowMediaLibrary(true)}
                  className="w-full h-48 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center text-gray-500 hover:border-gray-400"
                >
