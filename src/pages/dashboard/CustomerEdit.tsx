...
export default function CustomerEdit() {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: any) => customersAPI.update(Number(id), data),
    onSuccess: () => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button onClick={() => navigate(`/dashboard/customers/${id}`)} className="text-gray-600 hover:text-gray-900">
        ...
        <div className="flex gap-3">
          <button onClick={() => navigate(`/dashboard/customers/${id}`)} className="btn btn-secondary">
            Cancel
          </button>
