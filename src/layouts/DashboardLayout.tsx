...
export default function DashboardLayout() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      label: "Shipping",
      icon: "M3 7h11v5h4l3 3v4h-2a3 3 0 11-6 0H9a3 3 0 11-6 0H1V9a2 2 0 012-2zm12 5V7m0 5h4M6 21a1 1 0 100-2 1 1 0 000 2zm9 0a1 1 0 100-2 1 1 0 000 2",
    },
    {
      path: "/dashboard/payments",
      label: "Payments",
      icon: "M2 5h20a2 2 0 012 2v2H0V7a2 2 0 012-2zm22 6H0v6a2 2 0 002 2h20a2 2 0 002-2v-6zm-4 4h-6",
    },
    {
        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
          <div className="flex items-center justify-between px-8 py-4">
            ...
            <div className="flex items-center gap-4">
              <Link to="/" className="text-gray-600 hover:text-gray-900" target="_blank">
